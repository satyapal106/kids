    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">School Books</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">All School Book</a></li>
                </ol>
            </div>
            <div class="row">
                @if(count($data)!="")
                                ...
                                <div class="card-body">
                                    <div class="dropdown ml-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li class="dropdown-item"><a href="{{url('branch/update-school-book?id='.$row->id)}}"><i class="fa fa-edit text-primary mr-2"></i>Edit</a></li>
                                            @if($row->is_active == '1')
                                        ...
                                        <div class="col-xl-9 col-lg-6  col-md-6 col-xxl-7 col-sm-12">
                                            <div class="product-detail-content">
                                                ...
                                                <div class="new-arrival-content pr">
                                                    <h6 class="text-black">Book Name: {{$row->title}}</h6>
                                                    <p>Class: <span class="item">{{$row->class}}</span></p>
                                                    <p>Subject: <span class="item">{{$row->subject}}</span></p>
                                                    <p>School Name: <span class="item">{{$row->name}}</span></p>
                                                    <!-- Quanatity End -->
