    ...
    <div class="container-fluid">
      <div class="page-titles">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)"> Update About Detail</a></li>
         </ol>
      </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-block card-stretch create-workform">                    
                    ...
                    <form method="post" action="{!! url('branch/update-about') !!}" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{!! csrf_token() !!}"/>
                            <input type="hidden" name="where[id]" value="{!! $about->id !!}">
                            <!-- <input type="hidden" name="input[branch_id]" value=""> -->
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Title</label>
                                        <input type="text" class="form-control" id="title" name="input[title]" placeholder="Title" value="{!! $about->title !!}" required/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control ckeditor" name="input[description]">{{$about->description}}</textarea>
                                    </div>
                                </div>
