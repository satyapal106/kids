        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card card-block card-stretch create-workform">                    
                    ...
                    <form method="post" action="{!! url('branch/contact-us') !!}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" class="form-control" id="title" name="input[address]" placeholder="Address"  required/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
