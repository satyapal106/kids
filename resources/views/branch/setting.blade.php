        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card card-block card-stretch create-workform">                    
                    ...
                    <form method="post" action="{!! url('branch/setting') !!}" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{!! csrf_token() !!}"/>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Branch</label>
                                        <input type="text" class="form-control" id="title" name="input[branch]" placeholder="Branch"  required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Title Name</label>
                                        <input type="text" class="form-control" id="title" name="input[title_name]" placeholder="Title"  required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Contact Number</label>
                                        <input type="text" class="form-control" id="title" name="input[contact_number]" placeholder="Contact Number"  required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="email" class="form-control" id="title" name="input[email]" placeholder="Email"  required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Office Number</label>
                                        <input type="text" class="form-control" id="title" name="input[office_no]" placeholder="Office Number"  required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control ckeditor" name="input[address]"></textarea>
                                    </div>
                                </div>
