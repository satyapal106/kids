                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="{!! url('admin/new-school') !!}" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}"/>
                                <input type="hidden" name="where[id]" value="{!! isset($id) ? $id : '' !!}"/>
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label>Branch Name</label>
                                        <select name="input[branch_id]" id="" class="form-control">
                                            <option value="0">Select Branch</option>
                                            @if(count($branch)!="")
                                               @foreach($branch as $row)
                                                <option value="{{$row->id}}" {!! isset($id) ? ($details->branch_id == $row->id ? "Selected" : "") : "" !!}>{{$row->branch}}</option>
                                               @endforeach
                                            @endif
                                        </select>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="input[teacher_id]" value="{!! isset($id) ? $teacher->user_id : 'SCHTEA#'.date('dmYHis', time()) !!}" id="teacherId" placeholder="User Id" readonly>
                                                    </div>
                                                    <div class="col-sm-6 form-group">
                                                        <label for="Country">Password</label>
                                                        <input type="text" class="form-control" name="input[teacher_password]" value="{!! isset($id) ? $teacher->user_password : 'SCHTEA#'.date('his', time()) !!}" id="teacPass" placeholder="Pa
                                                        ssword" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                        <label for="Country">User ID</label>
                                                        <input type="text" class="form-control" name="input[student_id]" value="{!! isset($id) ? $student->user_id : 'SCHTEA#'.date('dmYHis', time()) !!}" id="teacherId" placeholder="User Id" readonly>
                                                    </div>
                                                    <div class="col-sm-6 form-group">
                                                        <label for="Country">Password</label>
