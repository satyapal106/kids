                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="{!! url('admin/new-subject') !!}" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}"/>
                                <input type="hidden" name="where[id]" value="{!! isset($id) ? $id : '' !!}"/>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>Subject Name <b style="color:red;">*</b></label>
                                        <input class="form-control" id="subject_name" placeholder="Subject Name" value="{!! isset($id) ? $details->subject : '' !!}" type="text" name="input[subject]" required />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Subject Url <b style="color:red;">*</b></label>
                                        <input class="form-control" id="subject_url" placeholder="Subject Url" value="{!! isset($id) ? $details->subject_url : '' !!}" type="text" name="input[subject_url]" required />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Subject Image <b style="color:red;">*</b></label>
                                        <input class="form-control" placeholder="image" value="{!! isset($id) ? $details->image : '' !!}" type="file" name="image">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Bg Color</label>
                                        <input class="form-control" placeholder="color" type="color" value="{!! isset($id) ? $details->background_color : '' !!}" name="input[background_color]" required />
                                    </div>
                                </div>
...
<script>
   ...
   $(document).on("change", "#subject_name", function(){
