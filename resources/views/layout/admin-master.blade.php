...
<head>
    ...
    <title>{!! $title !!}</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets')}}/images/adop_logointro_white.gif">
    ...
    <div id="main-wrapper">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span><strong>{!! Session::get('admin')->name !!}</strong></span>
									</div>
                                </a>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        @include('include/admin_left_sidebar')
        <!--**********************************
            Sidebar end
        ***********************************-->
		<!--**********************************
